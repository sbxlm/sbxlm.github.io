...
<span class="line"><span>    tips: char #none无注释,char单字注释,all全部注释</span></span></code></pre></div><p>完成以上步骤后，重新部署就可以生效。</p><p>在计算机上的声笔字提示效果如下：</p><p><img src="`+i+'" alt="电脑上的声笔字提示"></p><p>在手机上的声笔字提示效果效果如下：</p><p><img src="'+l+'" alt="电脑上的声笔字提示"></p><h2 id="实验结果" tabindex="-1">实验结果 <a class="header-anchor" href="#实验结果" aria-label="Permalink to &quot;实验结果&quot;">​</a></h2><p>使用发现，开滤镜提示sb字后，导致一简字不能参与造词。还没有找到解决办法，只能暂时放弃滤镜。</p><h2 id="结论" tabindex="-1">结论 <a class="header-anchor" href="#结论" aria-label="Permalink to &quot;结论&quot;">​</a></h2><p>保留码表优化结果，暂时放弃用滤镜提示声笔字的功能。</p>',59)]))}const g=a(t,[["render",c]]);export{r as __pageData,g as default};
