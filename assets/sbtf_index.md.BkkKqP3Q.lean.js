import{C as ht,o as Me,a0 as ft,b as Ee,M as Ot,K as Tt,c as j,U as F,x as K,av as Ht,aw as At,N as Ft,m as Y,j as Ve,V as Nt,w as Lt,a6 as jt,T as It,O as Dt,W as Be,ax as pt,D as qt,F as Vt,G as Qt,f as Ut,a as Wt,d as Kt,z as Xt,L as Yt,ay as Jt,Q as Gt,_ as ae,y as Zt,A as eo,B as to}from"./chunks/util.CqTrHbW7.js";import{W as se,h as M,gr as Ne,hK as le,l as vt,y as Oe,d as A,k as B,a4 as u,hJ as Te,O as mt,$ as oe,hU as oo,N as no,hL as He,hM as Qe,T as gt,U as Ue,o as Ae,b as ro,w as R,J as z,p as k,m as V,a as O,t as G,c as bt,e as io,E as so}from"./chunks/framework.DZys8jPX.js";import{i as ao,$ as lo,m as co,a as m,b as E,a0 as yt,h as $,f as b,a1 as xt,a2 as uo,e as I,u as T,y as _t,g as N,_ as wt,c as ho,N as Z}from"./chunks/Space.gxcKnwEi.js";import{N as Ct,k as Le,r as D,e as fo,b as po}from"./chunks/Input._tfVj9yp.js";import{I as We,S as vo,W as mo,E as go,N as Ke}from"./chunks/Progress.CO73MYeC.js";const X=M(null);function Xe(o){if(o.clientX>0||o.clientY>0)X.value={x:o.clientX,y:o.clientY};else{const{target:e}=o;if(e instanceof Element){const{left:t,top:n,width:r,height:i}=e.getBoundingClientRect();t>0||n>0?X.value={x:t+r/2,y:n+i/2}:X.value={x:0,y:0}}else X.value=null}}let ee=0,Ye=!0;function bo(){if(!ht)return se(M(null));ee===0&&Me("click",document,Xe,!0);const o=()=>{ee+=1};return Ye&&(Ye=ft())?(Ne(o),le(()=>{ee-=1,ee===0&&Ee("click",document,Xe,!0)})):o(),se(X)}const yo=M(void 0);let te=0;function Je(){yo.value=Date.now()}let Ge=!0;function xo(o){if(!ht)return se(M(!1));const e=M(!1);let t=null;function n(){t!==null&&window.clearTimeout(t)}function r(){n(),e.value=!0,t=window.setTimeout(()=>{e.value=!1},o)}te===0&&Me("click",window,Je,!0);const i=()=>{te+=1,Me("click",window,r,!0)};return Ge&&(Ge=ft())?(Ne(i),le(()=>{te-=1,te===0&&Ee("click",window,Je,!0),Ee("click",window,r,!0),n()})):i(),se(e)}let q=0,Ze="",et="",tt="",ot="";const nt=M("0px");function _o(o){if(typeof document>"u")return;const e=document.documentElement;let t,n=!1;const r=()=>{e.style.marginRight=Ze,e.style.overflow=et,e.style.overflowX=tt,e.style.overflowY=ot,nt.value="0px"};vt(()=>{t=Oe(o,i=>{if(i){if(!q){const s=window.innerWidth-e.offsetWidth;s>0&&(Ze=e.style.marginRight,e.style.marginRight=`${s}px`,nt.value=`${s}px`),et=e.style.overflow,tt=e.style.overflowX,ot=e.style.overflowY,e.style.overflow="hidden",e.style.overflowX="hidden",e.style.overflowY="hidden"}n=!0,q++}else q--,q||r(),n=!1},{immediate:!0})}),le(()=>{t==null||t(),n&&(q--,q||r(),n=!1)})}const je=M(!1),rt=()=>{je.value=!0},it=()=>{je.value=!1};let W=0;const wo=()=>(ao&&(Ne(()=>{W||(window.addEventListener("compositionstart",rt),window.addEventListener("compositionend",it)),W++}),le(()=>{W<=1?(window.removeEventListener("compositionstart",rt),window.removeEventListener("compositionend",it),W=0):W--})),je);function Co(o,e){return Ot(e,function(t){return o[t]})}function ko(o){return o==null?[]:Co(o,Tt(o))}var zo=Math.floor,Po=Math.random;function Ro(o,e){return o+zo(Po()*(e-o+1))}function kt(o,e){var t=-1,n=o.length,r=n-1;for(e=e===void 0?n:e;++t<e;){var i=Ro(t,r),s=o[i];o[i]=o[t],o[t]=s}return o.length=e,o}function $o(o){return kt(lo(o))}function So(o){return kt(ko(o))}function Mo(o){var e=co(o)?$o:So;return e(o)}const Eo=m([E("card",`
...
`,[m("&:first-child",{marginTop:0}),$("prefix-bar",{position:"relative",paddingLeft:"var(--n-prefix-width)"},[$("align-text",{paddingLeft:0},[m("&::before",{left:"calc(-1 * var(--n-prefix-width))"})]),m("&::before",`
 ...
 bottom: 0;
 position: absolute;
 `),m("&::before",{backgroundColor:"var(--n-bar-color)"})])]),Qo=Object.assign(Object.assign({},T.props),{type:{type:String,default:"default"},prefix:String,alignText:Boolean}),Q=o=>A({name:`H${o}`,props:Qo,setup(e){const{mergedClsPrefixRef:t,inlineThemeDisabled:n}=I(e),r=T("Typography","-h",Vo,ae,e,t),i=B(()=>{const{type:f}=e,{common:{cubicBezierEaseInOut:d},self:{headerFontWeight:c,headerTextColor:y,[N("headerPrefixWidth",o)]:p,[N("headerFontSize",o)]:w,[N("headerMargin",o)]:v,[N("headerBarWidth",o)]:_,[N("headerBarColor",f)]:S}}=r.value;return{"--n-bezier":d,"--n-font-size":w,"--n-margin":v,"--n-bar-color":S,"--n-bar-width":_,"--n-font-weight":c,"--n-text-color":y,"--n-prefix-width":p}}),s=n?j(`h${o}`,B(()=>e.type[0]),i,e):void 0;return{mergedClsPrefix:t,cssVars:n?void 0:i,themeClass:s==null?void 0:s.themeClass,onRender:s==null?void 0:s.onRender}},render(){var e;const{prefix:t,alignText:n,mergedClsPrefix:r,cssVars:i,$slots:s}=this;return(e=this.onRender)===null||e===void 0||e.call(this),u(`h${o}`,{class:[`${r}-h`,`${r}-h${o}`,this.themeClass,{[`${r}-h--prefix-bar`]:t,[`${r}-h--align-text`]:n}],style:i},s)}}),Uo=Q("1");Q("2");Q("3");Q("4");Q("5");Q("6");const Wo=E("a",`
 cursor: pointer;
 transition:
 color .3s var(--n-bezier),
 ...
 color: var(--n-text-color);
`),Ko=Object.assign({},T.props),Xo=A({name:"A",props:Ko,setup(o){const{mergedClsPrefixRef:e,inlineThemeDisabled:t}=I(o),n=T("Typography","-a",Wo,ae,o,e),r=B(()=>{const{common:{cubicBezierEaseInOut:s},self:{aTextColor:f}}=n.value;return{"--n-text-color":f,"--n-bezier":s}}),i=t?j("a",void 0,r,o):void 0;return{mergedClsPrefix:e,cssVars:t?void 0:r,themeClass:i==null?void 0:i.themeClass,onRender:i==null?void 0:i.onRender}},render(){var o;return(o=this.onRender)===null||o===void 0||o.call(this),u("a",{class:[`${this.mergedClsPrefix}-a`,this.themeClass],style:this.cssVars},this.$slots)}}),Yo=E("p",`
 box-sizing: border-box;
 transition: color .3s var(--n-bezier);
 margin: var(--n-margin);
 font-size: var(--n-font-size);
