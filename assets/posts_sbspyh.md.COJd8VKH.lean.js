import{_ as n,c as a,a3 as p,o as t}from"./chunks/framework.hU1yMXPg.js";const b=JSON.parse('{"title":"RIME版声笔双拼优化实验","description":"","frontmatter":{"title":"RIME版声笔双拼优化实验","date":"2019-08-13T14:13:52.000Z","tags":null},"headers":[],"relativePath":"posts/sbspyh.md","filePath":"posts/sbspyh.md"}'),l={name:"posts/sbspyh.md"};function e(i,s,c,o,d,r){return t(),a("div",null,s[0]||(s[0]=[p(`<h2 id="利用单字的短码空闲空间" tabindex="-1">利用单字的短码空闲空间 <a class="header-anchor" href="#利用单字的短码空闲空间" aria-label="Permalink to &quot;利用单字的短码空闲空间&quot;">​</a></h2><p>由于现在的声笔双拼只考虑了规则编码，所以单字编码在码长为2和3时都有不少的短码空间是空闲的，非常浪费。利用这种空间的办法是，将声笔简码的ss和ssb型二字词插入到该空间中。这种词现在有1098个，频度最高的一些二字词及其编码和频度如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>一个	ygu	997773</span></span>
...
<span class="line"><span>姑娘	gn	168226</span></span></code></pre></div><p>如果能充分使用上述简码二字词的话，对输入效率的提升是有帮助的，只是编码格式不一样，需要记忆。</p><p>另外，还有少量的sb和sbb型空间没有利用，如何利用？现在还没有考虑好。</p><h2 id="利用词组的三码空闲空间" tabindex="-1">利用词组的三码空闲空间 <a class="header-anchor" href="#利用词组的三码空闲空间" aria-label="Permalink to &quot;利用词组的三码空闲空间&quot;">​</a></h2><p>目前，声笔双拼中，编码sss是空闲的。优化的措施是，把最常见的词组取前三码作为其简码放在sss空间中，同时也保留它们的全码。也就是说，这种简码不是强制性的。不过，如果用户利用了简码，并且如果四码上有重码词组的话，在选择重码后，重码的词组就可以提前，就会多产生一个四键词组，从而提高输入效率。这种简码词组共有一万多条，下面是一些例子。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>没有	mzy	826617</span></span>
