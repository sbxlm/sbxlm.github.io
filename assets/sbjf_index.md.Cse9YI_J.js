import{_ as s,c as a,o as n,a5 as e}from"./chunks/framework.DO_HxD7r.js";const b=JSON.parse('{"title":"声笔简飞","description":"","frontmatter":{"title":"声笔简飞","date":"2024-05-13T07:55:56.000Z","comments":false,"tags":["声笔","简飞","顶功"],"typora-root-url":"..\\\\..\\\\public"},"headers":[],"relativePath":"sbjf/index.md","filePath":"docs/sbjf/index.md"}'),p={name:"sbjf/index.md"},t=e(`<h2 id="_1-简飞概述" tabindex="-1">1 简飞概述 <a class="header-anchor" href="#_1-简飞概述" aria-label="Permalink to &quot;1 简飞概述&quot;">​</a></h2><p>声笔简飞单，简称简飞，实际上只是一种经过特殊配置的声笔简码。由于需要配置不少选项，一般用户会觉得很麻烦，所以做了这个虚拟的简飞方案，以便用户开箱即用，或者在此基础上进行细微的调整，以适应自己的需要。</p><h3 id="_1-1-适用场景" tabindex="-1">1.1 适用场景 <a class="header-anchor" href="#_1-1-适用场景" aria-label="Permalink to &quot;1.1 适用场景&quot;">​</a></h3><h3 id="_1-2-比较优势" tabindex="-1">1.2 比较优势 <a class="header-anchor" href="#_1-2-比较优势" aria-label="Permalink to &quot;1.2 比较优势&quot;">​</a></h3><h3 id="_1-3-配置选项" tabindex="-1">1.3 配置选项 <a class="header-anchor" href="#_1-3-配置选项" aria-label="Permalink to &quot;1.3 配置选项&quot;">​</a></h3><p>为了让简码取得尽量高的输入效率，简飞采用了最专业的选项配置，涉及到的选项设置如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>switches:</span></span>
