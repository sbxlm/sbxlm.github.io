import{C as ht,o as Me,a0 as ft,b as Ee,M as Ot,K as Tt,c as L,U as F,x as K,av as Ht,aw as At,N as Ft,m as Y,j as Qe,V as Nt,w as jt,a6 as Lt,T as It,O as Dt,W as Be,ax as pt,D as qt,F as Qt,G as Vt,f as Ut,a as Wt,d as Kt,z as Xt,L as Yt,ay as Jt,Q as Gt,_ as ae,y as Zt,A as eo,B as to}from"./chunks/util.BuWB1DTP.js";import{W as se,h as M,gw as Ne,hP as le,l as vt,y as Oe,d as A,k as B,a4 as u,hO as Te,O as mt,$ as oe,hZ as oo,N as no,hQ as He,hR as Ve,T as gt,U as Ue,o as Ae,b as ro,w as R,J as z,p as k,m as Q,a as O,t as G,c as bt,e as io,E as so}from"./chunks/framework.D8YseNGg.js";import{i as ao,$ as lo,m as co,a as m,b as E,a0 as yt,h as $,f as b,a1 as xt,a2 as uo,e as I,u as T,y as _t,g as N,_ as wt,c as ho,N as Z}from"./chunks/Space.OJ9_uvSu.js";import{N as Ct,k as je,r as D,e as fo,b as po}from"./chunks/Input.CNU3mPMD.js";import{I as We,S as vo,W as mo,E as go,N as Ke}from"./chunks/Progress.Bl_KDGlR.js";const X=M(null);function Xe(o){if(o.clientX>0||o.clientY>0)X.value={x:o.clientX,y:o.clientY};else{const{target:e}=o;if(e instanceof Element){const{left:t,top:n,width:r,height:i}=e.getBoundingClientRect();t>0||n>0?X.value={x:t+r/2,y:n+i/2}:X.value={x:0,y:0}}else X.value=null}}let ee=0,Ye=!0;function bo(){if(!ht)return se(M(null));ee===0&&Me("click",document,Xe,!0);const o=()=>{ee+=1};return Ye&&(Ye=ft())?(Ne(o),le(()=>{ee-=1,ee===0&&Ee("click",document,Xe,!0)})):o(),se(X)}const yo=M(void 0);let te=0;function Je(){yo.value=Date.now()}let Ge=!0;function xo(o){if(!ht)return se(M(!1));const e=M(!1);let t=null;function n(){t!==null&&window.clearTimeout(t)}function r(){n(),e.value=!0,t=window.setTimeout(()=>{e.value=!1},o)}te===0&&Me("click",window,Je,!0);const i=()=>{te+=1,Me("click",window,r,!0)};return Ge&&(Ge=ft())?(Ne(i),le(()=>{te-=1,te===0&&Ee("click",window,Je,!0),Ee("click",window,r,!0),n()})):i(),se(e)}let q=0,Ze="",et="",tt="",ot="";const nt=M("0px");function _o(o){if(typeof document>"u")return;const e=document.documentElement;let t,n=!1;const r=()=>{e.style.marginRight=Ze,e.style.overflow=et,e.style.overflowX=tt,e.style.overflowY=ot,nt.value="0px"};vt(()=>{t=Oe(o,i=>{if(i){if(!q){const s=window.innerWidth-e.offsetWidth;s>0&&(Ze=e.style.marginRight,e.style.marginRight=`${s}px`,nt.value=`${s}px`),et=e.style.overflow,tt=e.style.overflowX,ot=e.style.overflowY,e.style.overflow="hidden",e.style.overflowX="hidden",e.style.overflowY="hidden"}n=!0,q++}else q--,q||r(),n=!1},{immediate:!0})}),le(()=>{t==null||t(),n&&(q--,q||r(),n=!1)})}const Le=M(!1),rt=()=>{Le.value=!0},it=()=>{Le.value=!1};let W=0;const wo=()=>(ao&&(Ne(()=>{W||(window.addEventListener("compositionstart",rt),window.addEventListener("compositionend",it)),W++}),le(()=>{W<=1?(window.removeEventListener("compositionstart",rt),window.removeEventListener("compositionend",it),W=0):W--})),Le);function Co(o,e){return Ot(e,function(t){return o[t]})}function ko(o){return o==null?[]:Co(o,Tt(o))}var zo=Math.floor,Po=Math.random;function Ro(o,e){return o+zo(Po()*(e-o+1))}function kt(o,e){var t=-1,n=o.length,r=n-1;for(e=e===void 0?n:e;++t<e;){var i=Ro(t,r),s=o[i];o[i]=o[t],o[t]=s}return o.length=e,o}function $o(o){return kt(lo(o))}function So(o){return kt(ko(o))}function Mo(o){var e=co(o)?$o:So;return e(o)}const Eo=m([E("card",`
