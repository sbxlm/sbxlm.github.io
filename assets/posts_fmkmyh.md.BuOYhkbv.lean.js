import{_ as a,c as n,a2 as p,o as e}from"./chunks/framework.HHeKTx91.js";const i="/images/sb105prompt1.webp",l="/images/sb105prompt2.webp",r=JSON.parse('{"title":"飞码（X）和快码（X）的优化实验","description":"","frontmatter":{"title":"飞码（X）和快码（X）的优化实验","date":"2019-08-15T13:29:34.000Z","tags":["飞码","快码","飞码X","快码X","优化"]},"headers":[],"relativePath":"posts/fmkmyh.md","filePath":"posts/fmkmyh.md"}'),t={name:"posts/fmkmyh.md"};function c(b,s,o,m,h,u){return e(),n("div",null,s[0]||(s[0]=[p(`<h2 id="存在的问题" tabindex="-1">存在的问题 <a class="header-anchor" href="#存在的问题" aria-label="Permalink to &quot;存在的问题&quot;">​</a></h2><p>在8.00的飞码（X）和快码（X）中，sbb和sbbb只是简单地放了声笔字，实际上几乎没投入使用，非常浪费。特别是在新增的飞码X和快码X中，因为没有sbbs型的二字词，sbb是只需要三键的短码空间，不好好利用的话，实在可惜。同时，飞码（X）中有少量spb短码空间是空闲的，而在快码（X）中存在着不少的sy和大量的syb短码空闲空间。</p><p>RIME版飞码（X）和快码（X）面临的另一个问题是，105个sb型简码字没有原生版那样的提示，初学者必须死记。</p><h2 id="短码空间的利用" tabindex="-1">短码空间的利用 <a class="header-anchor" href="#短码空间的利用" aria-label="Permalink to &quot;短码空间的利用&quot;">​</a></h2><h3 id="飞码-x" tabindex="-1">飞码（X） <a class="header-anchor" href="#飞码-x" aria-label="Permalink to &quot;飞码（X）&quot;">​</a></h3><p>首先，利用spb空闲空间。从声笔简码的二字词中抽出高频的填入该空间，脚本如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>select zici = rtrim(zici), bianma = left(bianma,3), chupin = case chupin when -1 then 0 else chupin end from sbjerz</span></span>
...
<span class="line"><span>order by chupin desc</span></span></code></pre></div><p>一共抽取了67个ssb型的二字词，罗列其中的前10条如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>那个	ngu	169294</span></span>
...
<span class="line"><span>暗中	vzi	23181</span></span></code></pre></div><p>其次，利用sbb空间。对于飞码和飞码X，利用的方式是不一样的。</p><p>对于飞码，在sbb上安排非强制性二字词简码，其取码规则为s1b1b1，SQL脚本如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>select text=rtrim(zici), code=left(bianma,3)</span></span>
...
<span class="line"><span>) tmp)</span></span></code></pre></div><p>一共抽取了451个二字词，罗列其中的前10条如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>告诉	gue</span></span>
...
<span class="line"><span>支持	zei</span></span></code></pre></div><p>对于飞码X，在为sbb空间安排二字词时，不能包含已经为其抽取的spb型二字词，脚本如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>select zici = rtrim(zici), bianma = left(bianma,1) + substring(bianma,3,2), </span></span>
...
<span class="line"><span>group by left(bianma,1) + substring(bianma,3,2)) tmp2)</span></span></code></pre></div><p>一共抽取了525个s1b2b2型的二字词，罗列其中的前10条如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>一个	yuo	997773</span></span>
...
<span class="line"><span>就是	jia	376685</span></span></code></pre></div><h3 id="快码-x" tabindex="-1">快码（X） <a class="header-anchor" href="#快码-x" aria-label="Permalink to &quot;快码（X）&quot;">​</a></h3><p>首先，利用sy空闲空间。从声笔简码的二字词中抽出高频的填入该空间，脚本如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>select zici = rtrim(zici), bianma = left(bianma,2), chupin = case chupin when -1 then 0 else chupin end from sbjerz</span></span>
...
<span class="line"><span>where a.changdu = 2 and b.changdu = 2)</span></span></code></pre></div><p>一共抽取了95个ss型的二字词，罗列其中的前10条如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>可以	ky	432546</span></span>
...
<span class="line"><span>一些	yx	165456</span></span></code></pre></div><p>第二，利用syb空闲空间。从声笔简码的二字词中抽出高频的填入该空间，脚本如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>select zici = rtrim(zici), bianma = left(bianma,3), chupin = case chupin when -1 then 0 else chupin end from sbjerz</span></span>
<span class="line"><span>where changdu = 3 and left(bianma,3) not in (</span></span>
<span class="line"><span>select bianma = left(a.bianma,3)</span></span>
<span class="line"><span>from ybdanz a</span></span>
<span class="line"><span>right join sbjerz b on left(a.bianma,3) = left(b.bianma,3)</span></span>
<span class="line"><span>where a.changdu = 3 and b.changdu = 3)</span></span>
<span class="line"><span>order by chupin desc</span></span></code></pre></div><p>一共抽取了587个ssb型的二字词，罗列其中的前10条如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>一个	ygu	997773</span></span>
...
<span class="line"><span>眼睛	yji	133992</span></span></code></pre></div><p>第三，利用sbb空间。对于快码和快码X，利用的方式是不一样的。</p><p>对于快码，在sbb上安排非强制性二字词简码，其取码规则为s1b1b1，SQL脚本如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>select text=rtrim(zici), code=left(bianma,3)</span></span>
...
<span class="line"><span>where len(rtrim(zici)) = 2</span></span>
<span class="line"><span>group by left(bianma,3)</span></span>
<span class="line"><span>) tmp)</span></span></code></pre></div><p>一共抽取了454个二字词，罗列其中的前10条如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>经济	jaa</span></span>
...
<span class="line"><span>改革	gae</span></span>
<span class="line"><span>国际	gia</span></span></code></pre></div><p>对于快码X，在为sbb空间安排二字词时，不能包含已经为其抽取的sy和syb型二字词，脚本如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>select zici = rtrim(zici), bianma = left(bianma,1) + substring(bianma,3,2),</span></span>
<span class="line"><span>chupin = case chupin when -1 then 0 else chupin end from sbjerz</span></span>
<span class="line"><span>where xuhao in (</span></span>
<span class="line"><span>select xuhao from</span></span>
<span class="line"><span>(select bianma = left(bianma,1) + substring(bianma,3,2), xuhao = min(xuhao) from sbjerz</span></span>
...
<span class="line"><span>where a.changdu = 3 and b.changdu = 3)</span></span>
<span class="line"><span>) tmp)</span></span>
<span class="line"><span>group by left(bianma,1) + substring(bianma,3,2)) tmp2)</span></span></code></pre></div><p>一共抽取了525个s1b2b2型的二字词，罗列其中的前10条如下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>没有	meu	826617</span></span>
<span class="line"><span>他们	tui	791018</span></span>
<span class="line"><span>什么	sua	742524</span></span>
<span class="line"><span>自己	zae	741012</span></span>
<span class="line"><span>知道	zou	574771</span></span>
...
<span class="line"><span>因为	you	317518</span></span></code></pre></div><h3 id="公共" tabindex="-1">公共 <a class="header-anchor" href="#公共" aria-label="Permalink to &quot;公共&quot;">​</a></h3><p>无论是飞码（X）还是快码（X），都还要利用sbbbx空间。将sbbb空间用于声笔单字输入，只有1、2级强制简码，重码字用aeiou来选择。声笔单字供用户在不知道偏旁部首或韵母时使用。‸</p><p>对于非X型的，脚本如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>select zici = rtrim(zici), bianma = left(bianma,changdu),</span></span>
...
<span class="line"><span>from sbdanz where changdu &gt; 2</span></span>
<span class="line"><span>order by chupin desc</span></span></code></pre></div><p>对于X型的，由于正码的单字码表中已经包含了1、2级简码，并且不再需要构词码，所以脚本如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>select zici = rtrim(zici), bianma = left(bianma,4),</span></span>
<span class="line"><span>chupin = case chupin when -1 then 0 else chupin end</span></span>
<span class="line"><span>from sbdanz where changdu &gt; 2</span></span></code></pre></div><h2 id="_105个sb简码字的提示" tabindex="-1">105个sb简码字的提示 <a class="header-anchor" href="#_105个sb简码字的提示" aria-label="Permalink to &quot;105个sb简码字的提示&quot;">​</a></h2><p>制作一个滤镜供飞码（X）和快码（X）使用，包括sb105.txt和sb105.json，放在Rime的OpenCC子文件夹中。</p><p>sb105.txt的内容如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>不	&amp;nbsp边a&amp;nbsp把e&amp;nbsp别i&amp;nbsp部o&amp;nbsp白u&amp;nbsp</span></span>
...
<span class="line"><span>在	&amp;nbsp子a&amp;nbsp正e&amp;nbsp中i&amp;nbsp着o&amp;nbsp自u&amp;nbsp</span></span></code></pre></div><p>sb105.json的内容如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>{</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>  }]</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>另外，再创建为飞码、飞码X、快码和快码X分别创建一个配置文件：sbfm.custom.yaml, sbfmx.custom.yaml, sbkm.custom.yaml和sbkmx.custom.yaml，放在Rime文件夹中。这个几个文件的内容完全一样，如下所示。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>patch:</span></span>
...
<span class="line"><span>    tips: char #none无注释,char单字注释,all全部注释</span></span></code></pre></div><p>完成以上步骤后，重新部署就可以生效。</p><p>在计算机上的声笔字提示效果如下：</p><p><img src="`+i+'" alt="电脑上的声笔字提示" loading="lazy"></p><p>在手机上的声笔字提示效果效果如下：</p><p><img src="'+l+'" alt="电脑上的声笔字提示" loading="lazy"></p><h2 id="实验结果" tabindex="-1">实验结果 <a class="header-anchor" href="#实验结果" aria-label="Permalink to &quot;实验结果&quot;">​</a></h2><p>使用发现，开滤镜提示sb字后，导致一简字不能参与造词。还没有找到解决办法，只能暂时放弃滤镜。</p><h2 id="结论" tabindex="-1">结论 <a class="header-anchor" href="#结论" aria-label="Permalink to &quot;结论&quot;">​</a></h2><p>保留码表优化结果，暂时放弃用滤镜提示声笔字的功能。</p>',59)]))}const g=a(t,[["render",c]]);export{r as __pageData,g as default};
