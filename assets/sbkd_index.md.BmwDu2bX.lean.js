...
`,[U("strong",`
 ...
 text-overflow: ellipsis;
 overflow: hidden;
 `)])])]),Ci=ae({name:"InternalSelection",props:Object.assign(Object.assign({},Ie.props),{clsPrefix:{type:String,required:!0},bordered:{type:Boolean,default:void 0},active:Boolean,pattern:{type:String,default:""},placeholder:String,selectedOption:{type:Object,default:null},selectedOptions:{type:Array,default:null},labelField:{type:String,default:"label"},valueField:{type:String,default:"value"},multiple:Boolean,filterable:Boolean,clearable:Boolean,disabled:Boolean,size:{type:String,default:"medium"},loading:Boolean,autofocus:Boolean,showArrow:{type:Boolean,default:!0},inputProps:Object,focused:Boolean,renderTag:Function,onKeydown:Function,onClick:Function,onBlur:Function,onFocus:Function,onDeleteOption:Function,maxTagCount:[String,Number],ellipsisTagPopoverProps:Object,onClear:Function,onPatternInput:Function,onPatternFocus:Function,onPatternBlur:Function,renderLabel:Function,status:String,inlineThemeDisabled:Boolean,ignoreComposition:{type:Boolean,default:!0},onResize:Function}),setup(e){const{mergedClsPrefixRef:o,mergedRtlRef:t}=Ve(e),n=kt("InternalSelection",t,o),r=O(null),i=O(null),l=O(null),a=O(null),c=O(null),p=O(null),u=O(null),v=O(null),g=O(null),b=O(null),m=O(!1),C=O(!1),k=O(!1),x=Ie("InternalSelection","-internal-selection",xi,Ln,e,fe(e,"clsPrefix")),$=T(()=>e.clearable&&!e.disabled&&(k.value||e.active)),D=T(()=>e.selectedOption?e.renderTag?e.renderTag({option:e.selectedOption,handleClose:()=>{}}):e.renderLabel?e.renderLabel(e.selectedOption,!0):ze(e.selectedOption[e.labelField],e.selectedOption,!0):e.placeholder),z=T(()=>{const S=e.selectedOption;if(S)return S[e.labelField]}),N=T(()=>e.multiple?!!(Array.isArray(e.selectedOptions)&&e.selectedOptions.length):e.selectedOption!==null);function G(){var S;const{value:A}=r;if(A){const{value:pe}=i;pe&&(pe.style.width=`${A.offsetWidth}px`,e.maxTagCount!=="responsive"&&((S=g.value)===null||S===void 0||S.sync({showAllItemsBeforeCalculate:!1})))}}function j(){const{value:S}=b;S&&(S.style.display="none")}function X(){const{value:S}=b;S&&(S.style.display="inline-block")}Be(fe(e,"active"),S=>{S||j()}),Be(fe(e,"pattern"),()=>{e.multiple&&Je(G)});function Q(S){const{onFocus:A}=e;A&&A(S)}function Y(S){const{onBlur:A}=e;A&&A(S)}function P(S){const{onDeleteOption:A}=e;A&&A(S)}function y(S){const{onClear:A}=e;A&&A(S)}function _(S){const{onPatternInput:A}=e;A&&A(S)}function K(S){var A;(!S.relatedTarget||!(!((A=l.value)===null||A===void 0)&&A.contains(S.relatedTarget)))&&Q(S)}function H(S){var A;!((A=l.value)===null||A===void 0)&&A.contains(S.relatedTarget)||Y(S)}function Z(S){y(S)}function M(){k.value=!0}function W(){k.value=!1}function te(S){!e.active||!e.filterable||S.target!==i.value&&S.preventDefault()}function ne(S){P(S)}function B(S){if(S.key==="Backspace"&&!f.value&&!e.pattern.length){const{selectedOptions:A}=e;A!=null&&A.length&&ne(A[A.length-1])}}const f=O(!1);let s=null;function L(S){const{value:A}=r;if(A){const pe=S.target.value;A.textContent=pe,G()}e.ignoreComposition&&f.value?s=S:_(S)}function ee(){f.value=!0}function Re(){f.value=!1,e.ignoreComposition&&_(s),s=null}function re(S){var A;C.value=!0,(A=e.onPatternFocus)===null||A===void 0||A.call(e,S)}function Se(S){var A;C.value=!1,(A=e.onPatternBlur)===null||A===void 0||A.call(e,S)}function w(){var S,A;if(e.filterable)C.value=!1,(S=p.value)===null||S===void 0||S.blur(),(A=i.value)===null||A===void 0||A.blur();else if(e.multiple){const{value:pe}=a;pe==null||pe.blur()}else{const{value:pe}=c;pe==null||pe.blur()}}function _e(){var S,A,pe;e.filterable?(C.value=!1,(S=p.value)===null||S===void 0||S.focus()):e.multiple?(A=a.value)===null||A===void 0||A.focus():(pe=c.value)===null||pe===void 0||pe.focus()}function xe(){const{value:S}=i;S&&(X(),S.focus())}function F(){const{value:S}=i;S&&S.blur()}function q(S){const{value:A}=u;A&&A.setTextContent(`+${S}`)}function ue(){const{value:S}=v;return S}function ye(){return i.value}let Pe=null;function Oe(){Pe!==null&&window.clearTimeout(Pe)}function Te(){e.active||(Oe(),Pe=window.setTimeout(()=>{N.value&&(m.value=!0)},100))}function Ke(){Oe()}function He(S){S||(Oe(),m.value=!1)}Be(N,S=>{S||(m.value=!1)}),Ye(()=>{Kt(()=>{const S=p.value;S&&(e.disabled?S.removeAttribute("tabindex"):S.tabIndex=C.value?-1:0)})}),Go(l,e.onResize);const{inlineThemeDisabled:Ae}=e,Ee=T(()=>{const{size:S}=e,{common:{cubicBezierEaseInOut:A},self:{borderRadius:pe,color:Rt,placeholderColor:Pt,textColor:lt,paddingSingle:at,paddingMultiple:st,caretColor:It,colorDisabled:Ot,textColorDisabled:dt,placeholderColorDisabled:De,colorActive:h,boxShadowFocus:E,boxShadowActive:J,boxShadowHover:se,border:ie,borderFocus:oe,borderHover:le,borderActive:we,arrowColor:$e,arrowColorDisabled:Tt,loadingColor:sn,colorActiveWarning:dn,boxShadowFocusWarning:cn,boxShadowActiveWarning:un,boxShadowHoverWarning:fn,borderWarning:hn,borderFocusWarning:vn,borderHoverWarning:pn,borderActiveWarning:mn,colorActiveError:gn,boxShadowFocusError:bn,boxShadowActiveError:yn,boxShadowHoverError:wn,borderError:xn,borderFocusError:Cn,borderHoverError:Sn,borderActiveError:kn,clearColor:zn,clearColorHover:Rn,clearColorPressed:Pn,clearSize:In,arrowSize:On,[de("height",S)]:Tn,[de("fontSize",S)]:Nn}}=x.value,ct=Qe(at),ut=Qe(st);return{"--n-bezier":A,"--n-border":ie,"--n-border-active":we,"--n-border-focus":oe,"--n-border-hover":le,"--n-border-radius":pe,"--n-box-shadow-active":J,"--n-box-shadow-focus":E,"--n-box-shadow-hover":se,"--n-caret-color":It,"--n-color":Rt,"--n-color-active":h,"--n-color-disabled":Ot,"--n-font-size":Nn,"--n-height":Tn,"--n-padding-single-top":ct.top,"--n-padding-multiple-top":ut.top,"--n-padding-single-right":ct.right,"--n-padding-multiple-right":ut.right,"--n-padding-single-left":ct.left,"--n-padding-multiple-left":ut.left,"--n-padding-single-bottom":ct.bottom,"--n-padding-multiple-bottom":ut.bottom,"--n-placeholder-color":Pt,"--n-placeholder-color-disabled":De,"--n-text-color":lt,"--n-text-color-disabled":dt,"--n-arrow-color":$e,"--n-arrow-color-disabled":Tt,"--n-loading-color":sn,"--n-color-active-warning":dn,"--n-box-shadow-focus-warning":cn,"--n-box-shadow-active-warning":un,"--n-box-shadow-hover-warning":fn,"--n-border-warning":hn,"--n-border-focus-warning":vn,"--n-border-hover-warning":pn,"--n-border-active-warning":mn,"--n-color-active-error":gn,"--n-box-shadow-focus-error":bn,"--n-box-shadow-active-error":yn,"--n-box-shadow-hover-error":wn,"--n-border-error":xn,"--n-border-focus-error":Cn,"--n-border-hover-error":Sn,"--n-border-active-error":kn,"--n-clear-size":In,"--n-clear-color":zn,"--n-clear-color-hover":Rn,"--n-clear-color-pressed":Pn,"--n-arrow-size":On}}),ve=Ae?qe("internal-selection",T(()=>e.size[0]),Ee,e):void 0;return{mergedTheme:x,mergedClearable:$,mergedClsPrefix:o,rtlEnabled:n,patternInputFocused:C,filterablePlaceholder:D,label:z,selected:N,showTagsPanel:m,isComposing:f,counterRef:u,counterWrapperRef:v,patternInputMirrorRef:r,patternInputRef:i,selfRef:l,multipleElRef:a,singleElRef:c,patternInputWrapperRef:p,overflowRef:g,inputTagElRef:b,handleMouseDown:te,handleFocusin:K,handleClear:Z,handleMouseEnter:M,handleMouseLeave:W,handleDeleteOption:ne,handlePatternKeyDown:B,handlePatternInputInput:L,handlePatternInputBlur:Se,handlePatternInputFocus:re,handleMouseEnterCounter:Te,handleMouseLeaveCounter:Ke,handleFocusout:H,handleCompositionEnd:Re,handleCompositionStart:ee,onPopoverUpdateShow:He,focus:_e,focusInput:xe,blur:w,blurInput:F,updateCounter:q,getCounter:ue,getTail:ye,renderLabel:e.renderLabel,cssVars:Ae?void 0:Ee,themeClass:ve==null?void 0:ve.themeClass,onRender:ve==null?void 0:ve.onRender}},render(){const{status:e,multiple:o,size:t,disabled:n,filterable:r,maxTagCount:i,bordered:l,clsPrefix:a,ellipsisTagPopoverProps:c,onRender:p,renderTag:u,renderLabel:v}=this;p==null||p();const g=i==="responsive",b=typeof i=="number",m=g||b,C=d(Kn,null,{default:()=>d(Sr,{clsPrefix:a,loading:this.loading,showArrow:this.showArrow,showClear:this.mergedClearable&&this.selected,onClear:this.handleClear},{default:()=>{var x,$;return($=(x=this.$slots).arrow)===null||$===void 0?void 0:$.call(x)}})});let k;if(o){const{labelField:x}=this,$=_=>d("div",{class:`${a}-base-selection-tag-wrapper`,key:_.value},u?u({option:_,handleClose:()=>{this.handleDeleteOption(_)}}):d(Et,{size:t,closable:!_.disabled,disabled:n,onClose:()=>{this.handleDeleteOption(_)},internalCloseIsButtonTag:!1,internalCloseFocusable:!1},{default:()=>v?v(_,!0):ze(_[x],_,!0)})),D=()=>(b?this.selectedOptions.slice(0,i):this.selectedOptions).map($),z=r?d("div",{class:`${a}-base-selection-input-tag`,ref:"inputTagElRef",key:"__input-tag__"},d("input",Object.assign({},this.inputProps,{ref:"patternInputRef",tabindex:-1,disabled:n,value:this.pattern,autofocus:this.autofocus,class:`${a}-base-selection-input-tag__input`,onBlur:this.handlePatternInputBlur,onFocus:this.handlePatternInputFocus,onKeydown:this.handlePatternKeyDown,onInput:this.handlePatternInputInput,onCompositionstart:this.handleCompositionStart,onCompositionend:this.handleCompositionEnd})),d("span",{ref:"patternInputMirrorRef",class:`${a}-base-selection-input-tag__mirror`},this.pattern)):null,N=g?()=>d("div",{class:`${a}-base-selection-tag-wrapper`,ref:"counterWrapperRef"},d(Et,{size:t,ref:"counterRef",onMouseenter:this.handleMouseEnterCounter,onMouseleave:this.handleMouseLeaveCounter,disabled:n})):void 0;let G;if(b){const _=this.selectedOptions.length-i;_>0&&(G=d("div",{class:`${a}-base-selection-tag-wrapper`,key:"__counter__"},d(Et,{size:t,ref:"counterRef",onMouseenter:this.handleMouseEnterCounter,disabled:n},{default:()=>`+${_}`})))}const j=g?r?d(Vt,{ref:"overflowRef",updateCounter:this.updateCounter,getCounter:this.getCounter,getTail:this.getTail,style:{width:"100%",display:"flex",overflow:"hidden"}},{default:D,counter:N,tail:()=>z}):d(Vt,{ref:"overflowRef",updateCounter:this.updateCounter,getCounter:this.getCounter,style:{width:"100%",display:"flex",overflow:"hidden"}},{default:D,counter:N}):b&&G?D().concat(G):D(),X=m?()=>d("div",{class:`${a}-base-selection-popover`},g?D():this.selectedOptions.map($)):void 0,Q=m?Object.assign({show:this.showTagsPanel,trigger:"hover",overlap:!0,placement:"top",width:"trigger",onUpdateShow:this.onPopoverUpdateShow,theme:this.mergedTheme.peers.Popover,themeOverrides:this.mergedTheme.peerOverrides.Popover},c):null,P=(this.selected?!1:this.active?!this.pattern&&!this.isComposing:!0)?d("div",{class:`${a}-base-selection-placeholder ${a}-base-selection-overlay`},d("div",{class:`${a}-base-selection-placeholder__inner`},this.placeholder)):null,y=r?d("div",{ref:"patternInputWrapperRef",class:`${a}-base-selection-tags`},j,g?null:z,C):d("div",{ref:"multipleElRef",class:`${a}-base-selection-tags`,tabindex:n?void 0:0},j,C);k=d(no,null,m?d(lo,Object.assign({},Q,{scrollable:!0,style:"max-height: calc(var(--v-target-height) * 6.6);"}),{trigger:()=>y,default:X}):y,P)}else if(r){const x=this.pattern||this.isComposing,$=this.active?!x:!this.selected,D=this.active?!1:this.selected;k=d("div",{ref:"patternInputWrapperRef",class:`${a}-base-selection-label`},d("input",Object.assign({},this.inputProps,{ref:"patternInputRef",class:`${a}-base-selection-input`,value:this.active?this.pattern:"",placeholder:"",readonly:n,disabled:n,tabindex:-1,autofocus:this.autofocus,onFocus:this.handlePatternInputFocus,onBlur:this.handlePatternInputBlur,onInput:this.handlePatternInputInput,onCompositionstart:this.handleCompositionStart,onCompositionend:this.handleCompositionEnd})),D?d("div",{class:`${a}-base-selection-label__render-label ${a}-base-selection-overlay`,key:"input"},d("div",{class:`${a}-base-selection-overlay__wrapper`},u?u({option:this.selectedOption,handleClose:()=>{}}):v?v(this.selectedOption,!0):ze(this.label,this.selectedOption,!0))):null,$?d("div",{class:`${a}-base-selection-placeholder ${a}-base-selection-overlay`,key:"placeholder"},d("div",{class:`${a}-base-selection-overlay__wrapper`},this.filterablePlaceholder)):null,C)}else k=d("div",{ref:"singleElRef",class:`${a}-base-selection-label`,tabindex:this.disabled?void 0:0},this.label!==void 0?d("div",{class:`${a}-base-selection-input`,title:Pr(this.label),key:"input"},d("div",{class:`${a}-base-selection-input__content`},u?u({option:this.selectedOption,handleClose:()=>{}}):v?v(this.selectedOption,!0):ze(this.label,this.selectedOption,!0))):d("div",{class:`${a}-base-selection-placeholder ${a}-base-selection-overlay`,key:"placeholder"},d("div",{class:`${a}-base-selection-placeholder__inner`},this.placeholder)),C);return d("div",{ref:"selfRef",class:[`${a}-base-selection`,this.rtlEnabled&&`${a}-base-selection--rtl`,this.themeClass,e&&`${a}-base-selection--${e}-status`,{[`${a}-base-selection--active`]:this.active,[`${a}-base-selection--selected`]:this.selected||this.active&&this.pattern,[`${a}-base-selection--disabled`]:this.disabled,[`${a}-base-selection--multiple`]:this.multiple,[`${a}-base-selection--focus`]:this.focused}],style:this.cssVars,onClick:this.onClick,onMouseenter:this.handleMouseEnter,onMouseleave:this.handleMouseLeave,onKeydown:this.onKeydown,onFocusin:this.handleFocusin,onFocusout:this.handleFocusout,onMousedown:this.handleMouseDown},k,l?d("div",{class:`${a}-base-selection__border`}):null,l?d("div",{class:`${a}-base-selection__state-border`}):null)}});function St(e){return e.type==="group"}function Xo(e){return e.type==="ignored"}function $t(e,o){try{return!!(1+o.toString().toLowerCase().indexOf(e.trim().toLowerCase()))}catch{return!1}}function Si(e,o){return{getIsGroup:St,getIgnored:Xo,getKey(n){return St(n)?n.name||n.key||"key-required":n[e]},getChildren(n){return n[o]}}}function ki(e,o,t,n){if(!o)return e;function r(i){if(!Array.isArray(i))return[];const l=[];for(const a of i)if(St(a)){const c=r(a[n]);c.length&&l.push(Object.assign({},a,{[n]:c}))}else{if(Xo(a))continue;o(t,a)&&l.push(a)}return l}return r(e)}function zi(e,o,t){const n=new Map;return e.forEach(r=>{St(r)?r[t].forEach(i=>{n.set(i[o],i)}):n.set(r[o],r)}),n}const ge="0!important",Zo="-1px!important";function Xe(e){return U(e+"-type",[V("& +",[I("button",{},[U(e+"-type",[R("border",{borderLeftWidth:ge}),R("state-border",{left:Zo})])])])])}function Ze(e){return U(e+"-type",[V("& +",[I("button",[U(e+"-type",[R("border",{borderTopWidth:ge}),R("state-border",{top:Zo})])])])])}const Ri=I("button-group",`
 flex-wrap: nowrap;
 display: inline-flex;
 position: relative;
